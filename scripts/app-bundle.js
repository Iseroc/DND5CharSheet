...
define('data/dataAccessor',["require", "exports", "aurelia-framework", "./models/characterAccessor", "./models/components/levelModel", "./models/components/characterModifyingElement", "./models/components/raceModel", "./models/inventoryAccessor", "./extra/translations", "./models/components/traitModel", "./models/components/itemModel", "./extra/enums", "./models/components/profiencyModel"], function (require, exports, aurelia_framework_1, characterAccessor_1, levelModel_1, characterModifyingElement_1, raceModel_1, inventoryAccessor_1, translations_1, traitModel_1, itemModel_1, enums_1, profiencyModel_1) {
    ...
    let DataAccessor = class DataAccessor {
        ...
        resetCharacter() {
            ...
            this.character.race.additionalTraits.push(new traitModel_1.TraitModel('Desert Nomad'));
            this.character.race.additionalTraits.push(new traitModel_1.TraitModel('Fey Ancestry'));
            this.character.race.additionalTraits.push(new traitModel_1.TraitModel('Keen Senses'));
            this.character.race.additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Nubian (elven)'));
            this.character.race.additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Trade common'));
            this.character.race.additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Druidic'));
            this.character.race.additionalSkillProfiencies.push(enums_1.SkillEnums.PERCEPTION);
            ...
            let wep1 = new itemModel_1.WeaponModel('Greatsword of Life Stealing +1', '2d6+1', 'Slashing');
            wep1.bonusAB = 2;
