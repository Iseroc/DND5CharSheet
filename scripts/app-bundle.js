...
define('components/inventory/item/item',["require", "exports", "aurelia-framework", "../../../data/dataAccessor", "../../../data/models/components/itemModel", "aurelia-framework"], function (require, exports, aurelia_framework_1, dataAccessor_1, itemModel_1, aurelia_framework_2) {
    ...
    ], Item.prototype, "editPopup", void 0);
    Item = __decorate([
        aurelia_framework_1.inject(dataAccessor_1.DataAccessor),
        __metadata("design:paramtypes", [dataAccessor_1.DataAccessor])
    ], Item);
...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"./normalize.css\"></require><require from=\"./styles.css\"></require><require from=\"./resources/fonts/font-awesome.min.css\"></require><nav class=\"navbar\" role=\"navigation\"><div class=\"navbar-placeholder\"></div><a class=\"navbar-item ${row.isActive ? 'active' : ''}\" repeat.for=\"row of router.navigation\" href.bind=\"row.href\">${row.title}</a></nav><div class=\"generalinfo\"><h1>${data.character.name}</h1><div style=\"position:fixed;top:0;right:0;margin:0 10px\"><button click.delegate=\"data.save()\">Save</button> <input type=\"file\" ref=\"fileinput\" change.delegate=\"data.loadFile(fileinput)\" style=\"display:none\"> <button click.delegate=\"data.load(fileinput)\">Load</button></div></div><div class=\"content\"><router-view></router-view></div></template>"; });
...
define('text!components/inventory/item/item.html', ['module'], function(module) { module.exports = "<template>${model.name}<ul><li repeat.for=\"prof of model.skillProfiency\">Grants profiency in ${prof}</li></ul><template if.bind=\"model.equippable\"><button click.delegate=\"unequip()\">Unequip</button> <button click.delegate=\"equip()\">Equip</button> <button click.delegate=\"editPopup(model)\">Edit</button></template></template>"; });
