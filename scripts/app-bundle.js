    ...
    let DataAccessor = class DataAccessor {
        ...
        openCharacter(charName) {
            if (charName === 'Galadin') {
                ...
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Simple weapons'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Martial weapons'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Desert weapons'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Light armor'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Medium armor'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Heavy armor'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Shields'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Sami drum'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Nubian (elven)'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Trade common'));
                this.character.levels[0].additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel('Druidic'));
                this.character.race.additionalTraits.push(new traitModel_1.TraitModel('Darkvision 120ft'));
                this.character.race.additionalTraits.push(new traitModel_1.TraitModel('Keen Hearing'));
...
define('text!components/character/skill/skill.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../resources/value-converters/skillCalculator\"></require><div class=\"skill-header\">${name}</div><div class=\"skill-value ${hasProfiency ? 'proficient' : ''}\" show.bind=\"!editMode\">${skillScore}</div></template>"; });
