    ...
    let DataAccessor = class DataAccessor {
        ...
        openCharacter(charName) {
            if (charName === 'Galadin') {
                ...
                for (let i = 0; i < 16; i++) {
                    this.character.model.levels.push(new levelModel_1.LevelModel('Paladin', 10));
                }
...
define('components/inventory/newItem/newItem',["require", "exports", "aurelia-framework", "aurelia-framework", "../../../data/dataAccessor", "../../../data/models/components/itemModel", "../../../data/extra/enums", "../../../data/models/components/profiencyModel", "../../../data/models/components/traitModel"], function (require, exports, aurelia_framework_1, aurelia_framework_2, dataAccessor_1, itemModel_1, enums_1, profiencyModel_1, traitModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('text!variables.css', ['module'], function(module) { module.exports = ".fa-button {\n  background: none;\n  border: none;\n  font-size: 13px;\n  padding: 0;\n  margin: 0;\n  height: auto;\n  cursor: pointer; }\n  .fa-button.red {\n    color: red; }\n  .fa-button.blue {\n    color: dodgerblue; }\n  .fa-button > i {\n    line-height: 18px; }\n\n.flex-container {\n  display: flex; }\n  .flex-container.flex-justify-center {\n    justify-content: center; }\n  .flex-container .flex-center {\n    text-align: center; }\n  .flex-container > * {\n    flex: 1 auto; }\n  .flex-container .flex-fixed {\n    flex: 0 auto; }\n"; });
define('text!components/inventory/inventory.html', ['module'], function(module) { module.exports = "<template><require from=\"./inventory.css\"></require><require from=\"./newItem/newItem\"></require><div class=\"contentArea\"><div class=\"itemArea\"><table class=\"itemTable\"><tr><th>Equipped</th><th>Attuned</th><th>Quantity</th></tr><tr repeat.for=\"item of data.inventory.equipped\"><td><span class=\"itemName\">${item.name}</span></td><td>-</td><td>-</td><td class=\"min-size\"><div if.bind=\"item.equippable\"><button click.delegate=\"unequip(item)\">Unequip</button> <button click.delegate=\"editItem(item)\">Edit</button></div></td></tr><tr class=\"secondTable\"><th>Backpack</th><th>Attunable</th><th>Quantity</th></tr><tr repeat.for=\"item of data.inventory.backpack\"><td><span class=\"itemName\">${item.name}</span></td><td>-</td><td>-</td><td class=\"min-size\"><div show.bind=\"item.equippable\"><button click.delegate=\"equip(item)\">Equip</button> <button click.delegate=\"editItem(item)\">Edit</button></div></td></tr></table></div><div class=\"functionsArea\"><button class=\"functionButton\" click.delegate=\"startCreatingNewItem()\">Create a new item</button></div></div><new-item state.two-way=\"creatingNewItem\"></new-item></template>"; });
define('text!components/functionsArea.css', ['module'], function(module) { module.exports = ".fa-button {\n  background: none;\n  border: none;\n  font-size: 13px;\n  padding: 0;\n  margin: 0;\n  height: auto;\n  cursor: pointer; }\n  .fa-button.red {\n    color: red; }\n  .fa-button.blue {\n    color: dodgerblue; }\n  .fa-button > i {\n    line-height: 18px; }\n\n.flex-container {\n  display: flex; }\n  .flex-container.flex-justify-center {\n    justify-content: center; }\n  .flex-container .flex-center {\n    text-align: center; }\n  .flex-container > * {\n    flex: 1 auto; }\n  .flex-container .flex-fixed {\n    flex: 0 auto; }\n\n.contentArea {\n  display: flex;\n  flex-direction: column;\n  height: 100%; }\n  .contentArea > * {\n    flex: 1 auto;\n    overflow-y: auto; }\n  .contentArea .functionsArea {\n    flex: 0 auto;\n    display: flex;\n    flex-direction: row-reverse;\n    height: 50px;\n    background: #eee;\n    border-top: 1px solid #979797; }\n    .contentArea .functionsArea .functionButton {\n      flex: 0 auto;\n      margin: auto 10px; }\n"; });
