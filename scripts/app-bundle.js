...
define('data/extra/translations',["require", "exports", "./enums"], function (require, exports, enums_1) {
    ...
    class Translations {
        ...
        initCharModStrings() {
            ...
            this.charModStrings.set(enums_1.CharModEnums.SETSTAT, 'Set stat to');
            this.charModStrings.set(enums_1.CharModEnums.ADDTOSTAT, 'Add to stat');
        }
        translateStat(stat) {
