...
define('components/character/character',["require", "exports", "aurelia-framework", "../../data/dataAccessor", "../../data/models/components/profiency", "../../data/models/components/traitModel"], function (require, exports, aurelia_framework_1, dataAccessor_1, profiency_1, traitModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let Character = class Character {
        ...
        addProfiency() {
            let prof = new profiency_1.Profiency(this.newProfiency);
...
define('text!components/character/stat/stat.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../resources/value-converters/statModifier\"></require><div class=\"stat\"><div class=\"stat-header\">${name}</div><div class=\"stat-value\"><span show.bind=\"!editMode\">${value}</span> <input show.bind=\"editMode\" type=\"number\" value.bind=\"value\"></div><div class=\"stat-modifier\">${value | statModifier}</div></div></template>"; });
