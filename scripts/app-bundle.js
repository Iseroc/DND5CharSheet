...
define('data/dataAccessor',["require", "exports", "aurelia-framework", "./models/characterAccessor", "./models/components/levelModel", "./models/inventoryAccessor", "./extra/translations", "./models/components/traitModel", "./models/components/itemModel", "./extra/enums", "./models/components/profiencyModel"], function (require, exports, aurelia_framework_1, characterAccessor_1, levelModel_1, inventoryAccessor_1, translations_1, traitModel_1, itemModel_1, enums_1, profiencyModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let DataAccessor = class DataAccessor {
        ...
        openCharacter(charName) {
            if (charName === 'Galadin') {
                ...
                this.character.setStat(enums_1.StatEnums.CON, 16);
                this.character.setStat(enums_1.StatEnums.INT, 8);
                this.character.setStat(enums_1.StatEnums.WIS, 12);
                this.character.setStat(enums_1.StatEnums.CHA, 18);
                this.character.addSkill(enums_1.SkillEnums.ATHLETICS);
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Simple weapons', 'equipment'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Martial weapons', 'equipment'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Desert weapons', 'equipment'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Light armor', 'equipment'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Medium armor', 'equipment'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Heavy armor', 'equipment'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Shields', 'equipment'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Sami drum', 'instrument'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Nubian (elven)', 'language'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Trade common', 'language'));
                this.character.addProfiency(new profiencyModel_1.ProfiencyModel('Druidic', 'language'));
                this.character.addTrait(new traitModel_1.TraitModel('Darkvision 120ft'));
                this.character.addTrait(new traitModel_1.TraitModel('Keen Hearing'));
...
define('data/models/inventoryAccessor',["require", "exports", "./components/itemModel", "./components/inventoryModel"], function (require, exports, itemModel_1, inventoryModel_1) {
    ...
    class InventoryAccessor {
        ...
        get weapons() {
            return this.model.equipped.filter(i => i instanceof itemModel_1.WeaponModel);
        }
        get traits() {
            let arr = [];
            ...
            if (!this.isEquipped(item)) {
                if (item instanceof itemModel_1.ArmorModel) {
                    for (let equippedArmor of this.equipped) {
                        if (equippedArmor instanceof itemModel_1.ArmorModel) {
...
define('components/character/character',["require", "exports", "aurelia-framework", "../../data/dataAccessor", "../../data/models/components/profiencyModel", "../../data/models/components/traitModel"], function (require, exports, aurelia_framework_1, dataAccessor_1, profiencyModel_1, traitModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let Character = class Character {
        ...
        addProfiency() {
            let prof = new profiencyModel_1.ProfiencyModel(this.newProfiency);
        ...
        addTrait() {
            let trait = new traitModel_1.TraitModel(this.newTrait);
...
define('components/levels/levels',["require", "exports", "aurelia-framework", "aurelia-templating-resources", "../../data/dataAccessor", "../../data/models/components/profiencyModel", "../../data/extra/enums"], function (require, exports, aurelia_framework_1, aurelia_templating_resources_1, dataAccessor_1, profiencyModel_1, enums_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let Levels = class Levels {
        ...
        addNewFeature(level, select) {
            if (enums_1.CharModEnums[select] === enums_1.CharModEnums[enums_1.CharModEnums.SKILLPROFIENCY]) {
                ...
                level.additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel("New profiency"));
            }
            else if (enums_1.CharModEnums[select] === enums_1.CharModEnums[enums_1.CharModEnums.TRAIT]) {
                level.additionalTraits.push(new profiencyModel_1.ProfiencyModel("New trait"));
            }
        }
...
define('data/models/components/inventoryModel',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('components/character/skill/skill',["require", "exports", "aurelia-framework", "aurelia-framework", "../../../data/dataAccessor", "../../../data/extra/enums"], function (require, exports, aurelia_framework_1, aurelia_framework_2, dataAccessor_1, enums_1) {
    ...
    ], Skill.prototype, "editMode", void 0);
    __decorate([
        aurelia_framework_1.bindable,
...
define('components/character/stat/stat',["require", "exports", "aurelia-framework", "aurelia-framework", "../../../data/dataAccessor", "../../../data/extra/enums"], function (require, exports, aurelia_framework_1, aurelia_framework_2, dataAccessor_1, enums_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let Stat = class Stat {
        constructor(data) {
...
define('components/inventory/itemPopup/editItem',["require", "exports", "aurelia-framework", "aurelia-framework", "../../../data/dataAccessor", "../../../data/models/components/itemModel", "./itemPopup"], function (require, exports, aurelia_framework_1, aurelia_framework_2, dataAccessor_1, itemModel_1, itemPopup_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let EditItem = class EditItem extends itemPopup_1.ItemPopup {
        constructor(data) {
            super(data);
            this.itemToEdit = null;
        }
        itemToEditChanged(newValue, oldValue) {
            if (newValue) {
                this.setup();
            }
        }
    ...
    ], EditItem.prototype, "cancelItem", void 0);
    __decorate([
        aurelia_framework_2.bindable,
        __metadata("design:type", itemModel_1.ItemModel)
    ], EditItem.prototype, "itemToEdit", void 0);
    EditItem = __decorate([
        aurelia_framework_1.inject(dataAccessor_1.DataAccessor),
        __metadata("design:paramtypes", [dataAccessor_1.DataAccessor])
    ], EditItem);
...
define('components/inventory/itemPopup/itemPopup',["require", "exports", "aurelia-framework", "aurelia-framework", "../../../data/dataAccessor", "../../../data/extra/enums", "../../../data/models/components/profiencyModel", "../../../data/models/components/traitModel"], function (require, exports, aurelia_framework_1, aurelia_framework_2, dataAccessor_1, enums_1, profiencyModel_1, traitModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let ItemPopup = class ItemPopup {
        ...
        addOtherProfiency() {
            if (this.newOtherProfiencyName) {
                this.additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel(this.newOtherProfiencyName, 'other'));
                this.newOtherProfiencyName = '';
            }
        }
        addTrait() {
...
define('components/inventory/itemPopup/newItem',["require", "exports", "aurelia-framework", "aurelia-framework", "../../../data/dataAccessor", "../../../data/models/components/itemModel", "./itemPopup"], function (require, exports, aurelia_framework_1, aurelia_framework_2, dataAccessor_1, itemModel_1, itemPopup_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let NewItem = class NewItem extends itemPopup_1.ItemPopup {
        constructor(data) {
            super(data);
        }
        createItemInternal() {
            ...
            if (this.selectedType === 'armor') {
                item = new itemModel_1.ArmorModel(this.name, itemModel_1.ArmorType.Medium, this.baseAC, this.maxDexBonus);
            }
    ...
    __decorate([
        aurelia_framework_2.bindable,
        __metadata("design:type", Function)
    ], NewItem.prototype, "cancelItem", void 0);
    __decorate([
        aurelia_framework_2.bindable,
        __metadata("design:type", Function)
    ], NewItem.prototype, "createItem", void 0);
    NewItem = __decorate([
        aurelia_framework_1.inject(dataAccessor_1.DataAccessor),
        __metadata("design:paramtypes", [dataAccessor_1.DataAccessor])
    ], NewItem);
...
define('components/levels/skillSelect/skillSelect',["require", "exports", "aurelia-framework", "../../../data/dataAccessor", "../../../data/extra/enums", "aurelia-templating-resources"], function (require, exports, aurelia_framework_1, dataAccessor_1, enums_1, aurelia_templating_resources_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"./normalize.css\"></require><require from=\"./styles.css\"></require><require from=\"./resources/fonts/font-awesome.min.css\"></require><nav class=\"navbar\" role=\"navigation\"><div class=\"navbar-placeholder\"></div><a class=\"navbar-item ${row.isActive ? 'active' : ''}\" repeat.for=\"row of router.navigation\" href.bind=\"row.href\">${row.title}</a></nav><div class=\"generalinfo\"><h1>${data.character.name}</h1><div class=\"saveAndLoadButtons\"><button click.delegate=\"data.save()\">Download</button> <input type=\"file\" ref=\"fileinput\" change.delegate=\"data.loadFile(fileinput)\" style=\"display:none\"> <button click.delegate=\"data.load(fileinput)\">Upload</button></div></div><div class=\"content\"><router-view></router-view></div></template>"; });
...
define('text!components/character/character.html', ['module'], function(module) { module.exports = "<template><require from=\"./character.css\"></require><require from=\"./skill/skill\"></require><require from=\"./stat/stat\"></require><require from=\"../../data/extra/enums\"></require><require from=\"../../resources/value-converters/select\"></require><div class=\"contentArea\"><div class=\"character\"><div class=\"attribute-area\"><table class=\"attribute-table\"><tr class=\"attribute\" repeat.for=\"stat of data.character.stats\"><td><stat model.bind=\"stat.key\" edit-mode.bind=\"editMode\"></stat></td><td><div class=\"skills\"><skill class=\"skill\" repeat.for=\"skillEnum of SkillEnums | select:stat.key\" model.bind=\"skillEnum\" edit-mode.bind=\"editMode\"></skill></div></td></tr></table></div><div class=\"features-area\"><div class=\"features\"><div class=\"profiency-area\"><h3 class=\"profiency-header\">Profiencies</h3><div class=\"profiency-list\"><ul><li class=\"flex-container\" repeat.for=\"prof of data.character.profiencies\"><span class=\"flex-normal\">${prof.name}</span> <button show.bind=\"editMode\" class=\"fa-button red flex-fixed\" click.delegate=\"removeProfiency(prof)\"><i class=\"fa fa-minus-circle\" aria-hidden=\"true\"></i></button></li><li class=\"flex-container\" repeat.for=\"prof of data.inventory.profiencies\"><span class=\"flex-normal\">${prof.name}</span> <span class=\"flex-fixed item-placeholder\" show.bind=\"editMode\">ITEM</span></li></ul><div class=\"flex-container\" show.bind=\"editMode\"><input class=\"flex-normal\" type=\"text\" value.bind=\"newProfiency\"> <button class=\"add-button flex-fixed\" click.delegate=\"addProfiency()\">Add</button></div></div></div><div class=\"traits-area\"><h3 class=\"traits-header\">Features and Traits</h3><div class=\"traits-list\"><ul><li class=\"flex-container\" repeat.for=\"trait of data.character.traits\"><span class=\"flex-normal\">${trait.name}</span> <button show.bind=\"editMode\" class=\"fa-button red flex-fixed\" click.delegate=\"removeTrait(trait)\"><i class=\"fa fa-minus-circle\" aria-hidden=\"true\"></i></button></li><li class=\"flex-container\" repeat.for=\"trait of data.inventory.traits\"><span class=\"flex-normal\">${trait.name}</span> <span class=\"flex-fixed item-placeholder\" show.bind=\"editMode\">ITEM</span></li></ul><div class=\"flex-container\" show.bind=\"editMode\"><input class=\"flex-normal\" type=\"text\" value.bind=\"newTrait\"> <button class=\"add-button flex-fixed\" click.delegate=\"addTrait()\">Add</button></div></div></div></div></div></div><div class=\"functionsArea\"><button class=\"functionButton\" click.delegate=\"toggleEditMode()\"><span if.bind=\"!editMode\">Edit</span> <span if.bind=\"editMode\">Save</span></button></div></div></template>"; });
...
define('text!components/levels/levels.html', ['module'], function(module) { module.exports = "<template><require from=\"../../data/extra/enums\"></require><require from=\"../../resources/value-converters/translate\"></require><require from=\"./levels.css\"></require><require from=\"./skillSelect/skillSelect\"></require>Race<table class=\"levelTable\"><tr><th>Level</th><th>Class</th><th>HD</th><th>Bonuses</th></tr><tr repeat.for=\"level of data.character.levels\"><td>${data.character.levels.indexOf(level) + 1}</td><td><input type=\"text\" value.bind=\"level.characterClass\"></td><td><input type=\"number\" value.bind=\"level.hd\" class=\"hdInput\"></td><td><div class=\"bonusesArea\"><table class=\"bonusesTable\"><tr repeat.for=\"skillProf of level.additionalSkillProfiencies\"><td>Skill profiency</td><td><skill-select current-skill.bind=\"skillProf\" list.bind=\"level.additionalSkillProfiencies\"></skill-select></td><td><button class=\"fa-button red removeButton\" click.delegate=\"removeSkill(level, skillProf)\"><i class=\"fa fa-minus-circle\" aria-hidden=\"true\"></i></button></td></tr><tr repeat.for=\"otherProf of level.additionalOtherProfiencies\"><td>Other profiency</td><td><input type=\"text\" class=\"inputElement\" value.bind=\"otherProf.name\"></td></tr><tr repeat.for=\"trait of level.additionalTraits\"><td>Trait</td><td><input type=\"text\" class=\"inputElement\" value.bind=\"trait.name\"></td></tr><tr><td><select ref=\"featureTypeSelect\"><option repeat.for=\"charmod of CharModEnums\" value.bind=\"charmod\">${charmod | translate:data.translations:'charmod'}</option></select></td><td><button class=\"addButton\" click.delegate=\"addNewFeature(level, featureTypeSelect.value)\">Add</button></td></tr></table></div></td></tr></table></template>"; });
define('text!components/character/character.css', ['module'], function(module) { module.exports = ".contentArea {\n  display: flex;\n  flex-direction: column;\n  height: 100%; }\n  .contentArea > *:not(.functionsArea) {\n    flex: 1 1 auto;\n    overflow-y: auto; }\n  .contentArea .functionsArea {\n    flex: 0 40px;\n    display: flex;\n    flex-direction: row-reverse;\n    height: 50px;\n    background: #eee;\n    border-top: 1px solid #979797; }\n    .contentArea .functionsArea .functionButton {\n      flex: 0 auto;\n      margin: auto 10px; }\n\n.character {\n  display: flex;\n  flex-flow: wrap;\n  height: calc(100% - 90px); }\n  .character .editbutton {\n    position: fixed;\n    top: 50px;\n    right: 0;\n    margin: 10px; }\n  .character .attribute-area {\n    flex: 1 60%;\n    padding: 0 10px; }\n  .character .attribute-table {\n    border-collapse: separate;\n    border-spacing: 0 10px; }\n  .character .attribute {\n    margin-top: 10px; }\n    .character .attribute .stat {\n      display: flex;\n      flex-direction: column;\n      border: 1px solid black;\n      padding: 5px; }\n      .character .attribute .stat .stat-header {\n        flex: 0 auto;\n        text-transform: uppercase;\n        font-size: 10px;\n        text-align: center; }\n      .character .attribute .stat .stat-value {\n        flex: 1 auto;\n        font-size: 24px;\n        vertical-align: middle;\n        text-align: center; }\n        .character .attribute .stat .stat-value .stat-editButton.left {\n          margin-left: 5px; }\n        .character .attribute .stat .stat-value .stat-editButton.right {\n          margin-right: 5px; }\n      .character .attribute .stat .stat-modifier {\n        flex: 0 auto;\n        font-size: 16px;\n        text-align: center; }\n    .character .attribute .skills {\n      display: flex;\n      max-height: 60px;\n      flex-direction: column;\n      rows: 3;\n      flex-wrap: wrap; }\n      .character .attribute .skills .skill {\n        flex: 0 auto;\n        padding: 0 10px;\n        margin: auto 0 0; }\n        .character .attribute .skills .skill .skill-header {\n          display: inline-block;\n          font-size: 10px;\n          text-transform: uppercase;\n          vertical-align: middle;\n          line-height: 18px; }\n        .character .attribute .skills .skill .skill-value {\n          width: 20px;\n          display: inline-block;\n          font-size: 16px;\n          margin-left: 5px;\n          vertical-align: middle; }\n          .character .attribute .skills .skill .skill-value.proficient {\n            font-weight: bold; }\n        .character .attribute .skills .skill .skill-edit {\n          width: 20px;\n          margin-left: 5px;\n          display: inline-block; }\n  .character .features-area {\n    flex: 1 40%;\n    padding: 0 10px 10px;\n    min-width: 185px; }\n    .character .features-area .features {\n      display: flex;\n      margin-bottom: 10px;\n      flex-direction: column; }\n      .character .features-area .features > * {\n        flex: 1 auto; }\n  .character .profiency-area {\n    padding: 0; }\n    .character .profiency-area .profiency-header {\n      margin: 10px 0; }\n    .character .profiency-area .profiency-list {\n      border: 1px solid black;\n      padding: 10px; }\n  .character .traits-area {\n    padding: 0; }\n    .character .traits-area .traits-header {\n      margin: 10px 0; }\n    .character .traits-area .traits-list {\n      border: 1px solid black;\n      padding: 10px; }\n  .character .profiency-area .add-button,\n  .character .traits-area .add-button {\n    margin-left: 5px; }\n  .character .profiency-area .item-placeholder,\n  .character .traits-area .item-placeholder {\n    color: #aaa;\n    font-size: 10px;\n    line-height: 16px; }\n"; });
define('text!components/spells/spells.html', ['module'], function(module) { module.exports = "<template><h1>Spells</h1></template>"; });
define('text!components/character/skill/skill.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../resources/value-converters/skillCalculator\"></require><div class=\"skill-header\">${name}</div><div class=\"skill-value ${hasProfiency ? 'proficient' : ''}\" show.bind=\"!editMode\">${skillScore}</div><div class=\"skill-edit\" show.bind=\"editMode\"><input type=\"checkbox\" checked.bind=\"hasProfiency\"></div></template>"; });
...
define('text!components/character/stat/stat.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../resources/value-converters/statModifier\"></require><div class=\"stat\"><div class=\"stat-header\">${name}</div><div class=\"stat-value flex-container flex-justify-center\"><button show.bind=\"editMode\" class=\"fa-button blue flex-fixed stat-editButton left\" click.delegate=\"subtract()\"><i class=\"fa fa-minus-circle\" aria-hidden=\"true\"></i></button> <span class=\"flex-fixeds\">${value}</span> <button show.bind=\"editMode\" class=\"fa-button blue flex-fixed stat-editButton right\" click.delegate=\"add()\"><i class=\"fa fa-plus-circle\" aria-hidden=\"true\"></i></button></div><div class=\"stat-modifier\">${value | statModifier}</div></div></template>"; });
define('text!components/levels/levels.css', ['module'], function(module) { module.exports = ".levelTable > tbody > tr > td {\n  padding-bottom: 10px;\n  vertical-align: top; }\n\n.levelTable .hdInput {\n  width: 50px; }\n\n.levelTable .bonusesArea {\n  border: 1px solid black;\n  padding: 10px;\n  margin-left: 10px; }\n  .levelTable .bonusesArea .bonusesTable > tbody > tr:not(:last-child) > td {\n    padding-bottom: 5px; }\n  .levelTable .bonusesArea .bonusesTable .inputElement {\n    width: 130px; }\n  .levelTable .bonusesArea .bonusesTable .addButton,\n  .levelTable .bonusesArea .bonusesTable .removeButton {\n    margin-left: 5px; }\n"; });
define('text!components/inventory/itemPopup/editItem.html', ['module'], function(module) { module.exports = "<template><require from=\"./itemPopup.css\"></require><require from=\"../../../data/extra/enums\"></require><require from=\"../../../resources/value-converters/translate\"></require><div class=\"newItemArea\"><input class=\"itemName\" type=\"text\" placeholder=\"Name\" value.bind=\"name\"><div class=\"typeSelectArea\"><div class=\"typeTabs\"><div><input type=\"radio\" name=\"typeradio\" value=\"item\" checked.bind=\"selectedType\" id=\"itemradio\" ref=\"itemradio\" disabled=\"disabled\"><label for=\"itemradio\">Item</label></div><div><input type=\"radio\" name=\"typeradio\" value=\"armor\" checked.bind=\"selectedType\" id=\"armorradio\" ref=\"armorradio\" disabled=\"disabled\"><label for=\"armorradio\">Armor</label></div><div><input type=\"radio\" name=\"typeradio\" value=\"weapon\" checked.bind=\"selectedType\" id=\"weaponradio\" ref=\"weaponradio\" disabled=\"disabled\"><label for=\"weaponradio\">Weapon</label></div></div><div class=\"itemContentArea\"><div show.bind=\"itemradio.checked\" class=\"flex-container\"><div class=\"textInput flex-center\"><label>Quantity</label><input type=\"number\" value.bind=\"quantity\" placeholder=\"Quantity\"></div><div class=\"flex-center itemEquippable\"><label><input type=\"checkbox\" class=\"labelCheckBox\" checked.bind=\"equippable\">Equippable</label></div></div><div show.bind=\"armorradio.checked\" class=\"flex-container\"><div class=\"textInput flex-center\"><label>Base AC</label><input type=\"number\" value.bind=\"baseAC\" placeholder=\"Base AC\"></div><div class=\"textInput flex-center\"><label>Max Dex bonus</label><input type=\"number\" value.bind=\"maxDexBonus\" placeholder=\"Max Dex bonus\"></div></div><div show.bind=\"weaponradio.checked\" class=\"flex-container\"><div class=\"textInput flex-center\"><label>Damage</label><input type=\"text\" value.bind=\"damage\" placeholder=\"1d8\"></div><div class=\"textInput flex-center\"><label>Type</label><input type=\"text\" value.bind=\"damageType\" placeholder=\"Slashing\"></div></div></div></div><div class=\"flexArea\"><div class=\"itemContentArea\"><label><input type=\"checkbox\" class=\"labelCheckBox\" checked.bind=\"attunement\">Requires attunement</label></div><div class=\"skillArea\"><span class=\"header\">Skills</span><ul><li class=\"listItem\" repeat.for=\"skill of additionalSkillProfiencies\">${skill | translate:data.translations:'skill' }</li></ul><div class=\"flex-container\"><select value.bind=\"selectedSkillProfiency\"><option repeat.for=\"skillEnum of SkillEnums\" model.bind=\"skillEnum\">${skillEnum | translate:data.translations:'skill' }</option></select><button class=\"flex-fixed addButton\" click.delegate=\"addSkillProfiency()\">Add</button></div></div><div class=\"profiencyArea\"><span class=\"header\">Other profiencies</span><ul><li class=\"listItem\" repeat.for=\"profiency of additionalOtherProfiencies\">${profiency.name}</li></ul><div class=\"flex-container\"><input type=\"text\" placeholder=\"New profiency name\" value.bind=\"newOtherProfiencyName\"> <button class=\"flex-fixed addButton\" click.delegate=\"addOtherProfiency()\">Add</button></div></div><div class=\"traitArea\"><span class=\"header\">Traits</span><ul><li class=\"listItem\" repeat.for=\"trait of additionalTraits\">${trait.name}</li></ul><div class=\"flex-container\"><input type=\"text\" placeholder=\"New trait name\" value.bind=\"newTraitName\"> <button class=\"flex-fixed addButton\" click.delegate=\"addTrait()\">Add</button></div></div></div><div class=\"buttonArea\"><button class=\"createButton\" click.delegate=\"reset()\">Cancel</button> <button class=\"createButton\" disabled.bind=\"!name\" click.delegate=\"saveItem()\">Save item</button></div></div></template>"; });
define('text!components/inventory/itemPopup/itemPopup.css', ['module'], function(module) { module.exports = ".newItemArea {\n  display: flex;\n  flex-direction: column;\n  margin-right: 1px;\n  position: fixed;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%);\n  background: #eee;\n  border: 1px solid #979797;\n  box-shadow: 0 2px 3px #aaa;\n  max-height: 90vh;\n  /* Generic styles */\n  /* Area styles */ }\n  .newItemArea .labelCheckBox {\n    margin-right: 5px; }\n  .newItemArea .textInput > label {\n    display: block;\n    text-transform: uppercase;\n    font-size: 9px;\n    margin-bottom: 2px; }\n  .newItemArea .itemName {\n    margin: 10px;\n    padding: 3px; }\n  .newItemArea .typeSelectArea {\n    border-top: 1px solid #979797;\n    border-bottom: 1px solid #979797; }\n    .newItemArea .typeSelectArea .typeTabs {\n      display: flex;\n      flex-direction: row; }\n      .newItemArea .typeSelectArea .typeTabs > div {\n        flex: 1 auto;\n        border-right: 1px solid #979797;\n        border-bottom: 1px solid #979797; }\n        .newItemArea .typeSelectArea .typeTabs > div:last-child {\n          border-right: none; }\n        .newItemArea .typeSelectArea .typeTabs > div > input {\n          display: none; }\n        .newItemArea .typeSelectArea .typeTabs > div > label {\n          display: inline-block;\n          width: 100%;\n          padding: 5px;\n          text-align: center;\n          text-transform: uppercase;\n          font-size: 12px; }\n        .newItemArea .typeSelectArea .typeTabs > div input:not([disabled]) + label:hover {\n          background-color: #ddd; }\n        .newItemArea .typeSelectArea .typeTabs > div input[disabled] + label {\n          color: grey; }\n  .newItemArea .itemContentArea {\n    margin: 10px; }\n    .newItemArea .itemContentArea .itemEquippable {\n      display: flex;\n      flex-direction: column;\n      justify-content: center;\n      margin-left: 10px; }\n  .newItemArea .flexArea {\n    overflow-y: auto;\n    margin-right: 1px;\n    margin-bottom: 1px;\n    flex: 1 auto; }\n    .newItemArea .flexArea .profiencyArea,\n    .newItemArea .flexArea .traitArea,\n    .newItemArea .flexArea .skillArea {\n      margin: 0 10px 10px 10px; }\n      .newItemArea .flexArea .profiencyArea .header,\n      .newItemArea .flexArea .traitArea .header,\n      .newItemArea .flexArea .skillArea .header {\n        font-size: 12px;\n        text-transform: uppercase;\n        margin: 10px 0; }\n      .newItemArea .flexArea .profiencyArea .listItem,\n      .newItemArea .flexArea .traitArea .listItem,\n      .newItemArea .flexArea .skillArea .listItem {\n        font-size: 14px; }\n      .newItemArea .flexArea .profiencyArea .addButton,\n      .newItemArea .flexArea .traitArea .addButton,\n      .newItemArea .flexArea .skillArea .addButton {\n        margin-left: 5px; }\n  .newItemArea .buttonArea {\n    padding: 10px;\n    display: flex;\n    flex-direction: row-reverse;\n    border-top: 1px solid #979797; }\n    .newItemArea .buttonArea .createButton {\n      flex: 0 auto;\n      margin-left: 10px; }\n"; });
define('text!components/inventory/itemPopup/newItem.html', ['module'], function(module) { module.exports = "<template><require from=\"./itemPopup.css\"></require><require from=\"../../../data/extra/enums\"></require><require from=\"../../../resources/value-converters/translate\"></require><div class=\"newItemArea\"><input class=\"itemName\" type=\"text\" placeholder=\"Name\" value.bind=\"name\"><div class=\"typeSelectArea\"><div class=\"typeTabs\"><div><input type=\"radio\" name=\"typeradio\" value=\"item\" checked.bind=\"selectedType\" id=\"itemradio\" ref=\"itemradio\"><label for=\"itemradio\">Item</label></div><div><input type=\"radio\" name=\"typeradio\" value=\"armor\" checked.bind=\"selectedType\" id=\"armorradio\" ref=\"armorradio\"><label for=\"armorradio\">Armor</label></div><div><input type=\"radio\" name=\"typeradio\" value=\"weapon\" checked.bind=\"selectedType\" id=\"weaponradio\" ref=\"weaponradio\"><label for=\"weaponradio\">Weapon</label></div></div><div class=\"itemContentArea\"><div show.bind=\"itemradio.checked\" class=\"flex-container\"><div class=\"textInput flex-center\"><label>Quantity</label><input type=\"number\" value.bind=\"quantity\" placeholder=\"Quantity\"></div><div class=\"flex-center itemEquippable\"><label><input type=\"checkbox\" class=\"labelCheckBox\" checked.bind=\"equippable\">Equippable</label></div></div><div show.bind=\"armorradio.checked\" class=\"flex-container\"><div class=\"textInput flex-center\"><label>Base AC</label><input type=\"number\" value.bind=\"baseAC\" placeholder=\"Base AC\"></div><div class=\"textInput flex-center\"><label>Max Dex bonus</label><input type=\"number\" value.bind=\"maxDexBonus\" placeholder=\"Max Dex bonus\"></div></div><div show.bind=\"weaponradio.checked\" class=\"flex-container\"><div class=\"textInput flex-center\"><label>Damage</label><input type=\"text\" value.bind=\"damage\" placeholder=\"1d8\"></div><div class=\"textInput flex-center\"><label>Type</label><input type=\"text\" value.bind=\"damageType\" placeholder=\"Slashing\"></div></div></div></div><div class=\"flexArea\"><div class=\"itemContentArea\"><label><input type=\"checkbox\" class=\"labelCheckBox\" checked.bind=\"attunement\">Requires attunement</label></div><div class=\"skillArea\"><span class=\"header\">Skills</span><ul><li class=\"listItem\" repeat.for=\"skill of additionalSkillProfiencies\">${skill | translate:data.translations:'skill' }</li></ul><div class=\"flex-container\"><select value.bind=\"selectedSkillProfiency\"><option repeat.for=\"skillEnum of SkillEnums\" model.bind=\"skillEnum\">${skillEnum | translate:data.translations:'skill' }</option></select><button class=\"flex-fixed addButton\" click.delegate=\"addSkillProfiency()\">Add</button></div></div><div class=\"profiencyArea\"><span class=\"header\">Other profiencies</span><ul><li class=\"listItem\" repeat.for=\"profiency of additionalOtherProfiencies\">${profiency.name}</li></ul><div class=\"flex-container\"><input type=\"text\" placeholder=\"New profiency name\" value.bind=\"newOtherProfiencyName\"> <button class=\"flex-fixed addButton\" click.delegate=\"addOtherProfiency()\">Add</button></div></div><div class=\"traitArea\"><span class=\"header\">Traits</span><ul><li class=\"listItem\" repeat.for=\"trait of additionalTraits\">${trait.name}</li></ul><div class=\"flex-container\"><input type=\"text\" placeholder=\"New trait name\" value.bind=\"newTraitName\"> <button class=\"flex-fixed addButton\" click.delegate=\"addTrait()\">Add</button></div></div></div><div class=\"buttonArea\"><button class=\"createButton\" click.delegate=\"reset()\">Cancel</button> <button class=\"createButton\" disabled.bind=\"!name\" click.delegate=\"createItemInternal()\">Create</button></div></div></template>"; });
define('text!components/levels/skillSelect/skillSelect.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../data/extra/enums\"></require><require from=\"../../../resources/value-converters/translate\"></require><select class=\"inputElement\" value.bind=\"currentSkill\"><option repeat.for=\"skill of SkillEnums\" model.bind=\"skill\" disabled.bind=\"list.includes(skill) & signal:'skill-list-changed'\">${skill | translate:data.translations:'skill'}</option></select></template>"; });
