    ...
    let DataAccessor = class DataAccessor {
        ...
        openCharacter(charName) {
            if (charName === 'Galadin') {
                ...
                this.character.levels[0].additionalSkillProfiencies.push(enums_1.SkillEnums.ATHLETICS);
    ...
    let Charmod = class Charmod {
        ...
        addNewFeature(select) {
            if (enums_1.CharModEnums[select] === enums_1.CharModEnums[enums_1.CharModEnums.SKILLPROFIENCY]) {
                ...
                this.model.additionalOtherProfiencies.push(new profiencyModel_1.ProfiencyModel("New profiency"));
            }
            else if (enums_1.CharModEnums[select] === enums_1.CharModEnums[enums_1.CharModEnums.TRAIT]) {
                this.model.additionalTraits.push(new profiencyModel_1.ProfiencyModel("New trait"));
            }
        }
        removeSkill(skill) {
...
define('components/inventory/itemPopup/itemPopup',["require", "exports", "aurelia-framework", "aurelia-framework", "../../../data/dataAccessor", "../../../data/models/components/characterModifyingElement"], function (require, exports, aurelia_framework_1, aurelia_framework_2, dataAccessor_1, characterModifyingElement_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let ItemPopup = class ItemPopup {
        constructor(data) {
            this.data = data;
            this.innerModel = new characterModifyingElement_1.CharacterModifyingElement();
            this.name = '';
            this.selectedType = 'item';
...
define('components/shared/skillSelect/skillSelect',["require", "exports", "aurelia-framework", "../../../data/dataAccessor", "../../../data/extra/enums", "aurelia-templating-resources"], function (require, exports, aurelia_framework_1, dataAccessor_1, enums_1, aurelia_templating_resources_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
            ...
            if (json) {
                ...
                for (var eItem of json.equipped) {
                    if (eItem.class === "item") {
                        ...
                        let item = new itemModel_1.ArmorModel("", itemModel_1.ArmorType.Clothing, 10, 8);
                        item.fillFromJSON(eItem);
                        model.equipped.push(item);
                    }
                    else if (eItem.class === "weapon") {
                        let item = new itemModel_1.WeaponModel("", "", "");
                        item.fillFromJSON(eItem);
                        model.equipped.push(item);
                    }
                }
...
define('text!components/shared/charmod.html', ['module'], function(module) { module.exports = "<template><require from=\"./charmod.css\"></require><require from=\"./skillSelect/skillSelect\"></require><require from=\"../../data/extra/enums\"></require><require from=\"../../resources/value-converters/translate\"></require><table class=\"bonusesTable\"><tr repeat.for=\"skillProf of model.additionalSkillProfiencies\"><td>Skill profiency</td><td><skill-select current-skill.bind=\"skillProf\" list.bind=\"model.additionalSkillProfiencies\"></skill-select></td><td><button class=\"fa-button red removeButton\" click.delegate=\"removeSkill(skillProf)\"><i class=\"fa fa-minus-circle\" aria-hidden=\"true\"></i></button></td></tr><tr repeat.for=\"otherProf of model.additionalOtherProfiencies\"><td>Other profiency</td><td><input type=\"text\" class=\"inputElement\" value.bind=\"otherProf.name\"></td></tr><tr repeat.for=\"trait of model.additionalTraits\"><td>Trait</td><td><input type=\"text\" class=\"inputElement\" value.bind=\"trait.name\"></td></tr><tr><td><select ref=\"featureTypeSelect\"><option repeat.for=\"charmod of CharModEnums\" value.bind=\"charmod\">${charmod | translate:data.translations:'charmod'}</option></select></td><td><button class=\"addButton\" click.delegate=\"addNewFeature(featureTypeSelect.value)\">Add</button></td></tr></table></template>"; });
